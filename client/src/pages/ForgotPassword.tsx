...
// import { useResentResetOtpMutation, useForgotPasswordMutation, useVerifyResetOtpMutation, useSetNewPasswordMutation } from "../api/authApi"
...
//   const [] =useVerifyResetOtpMutation()
//   const [] = useSetNewPasswordMutation()
//   const [] = useResentResetOtpMutation()
...
//           />
//           <div
//             className={`h-1 flex-1 rounded-full transition-colors ${["otp", "password"].includes(step) ? "bg-blue-600" : "bg-slate-700"
//               }`}
//           />
//           <div
//             className={`h-1 flex-1 rounded-full transition-colors ${step === "password" ? "bg-blue-600" : "bg-slate-700"
//               }`}
//           />
//         </div>
